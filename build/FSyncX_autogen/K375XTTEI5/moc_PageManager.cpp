...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PageManager_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PageManager_t qt_meta_stringdata_PageManager = {
    {
QT_MOC_LITERAL(0, 0, 11) // "PageManager"
...
static const uint qt_meta_data_PageManager[] = {
...
QT_INIT_METAOBJECT const QMetaObject PageManager::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_PageManager.data,
